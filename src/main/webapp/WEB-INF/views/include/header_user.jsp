...
<body>
	...
	<div class="container">
		...
		<div class="flex-item">
			<form action="." method="post">
				...
				<div class="search">
					<form action="">
						<input class="search_input" type="text" name="" id="" placeholder="검색어 입력...">
						<button type="submit">
	...
	<div class="container" style="margin-bottom: 2px;">
		...
		<ul class="nav nav-pills nav-fill bg-light text-black">
			<!-- 버튼1-->
			<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="dropdownMenuLink" role="button"
