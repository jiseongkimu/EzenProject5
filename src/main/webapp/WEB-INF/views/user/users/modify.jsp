...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/userInterface.css">
</head>
<body>
					...
					<div class="card-body">
						<div class="tab-content" id="nav-tabContent">
							...
							<div class="tab-pane fade" id="list-withdraw" role="tabpanel"
								aria-labelledby="list-withdraw-list">회원 탈퇴</div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="vertical-tab" role="tabpanel">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#Section1"
								aria-controls="profile" role="tab" data-toggle="tab">Section 1</a></li>
							<li role="presentation"><a href="#Section2"
								aria-controls="order" role="tab" data-toggle="tab">Section
									2</a></li>
							<li role="presentation"><a href="#Section3"
								aria-controls="support" role="tab" data-toggle="tab">Section
									3</a></li>
						</ul>
						<!-- Tab panes -->
						<div class="tab-content tabs">
							<div role="tabpanel" class="tab-pane fade in active"
								...
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
									...
									felis ac felis dapibus, non iaculis mi varius, mi eros viverra
									massa.</p>
							</div>
