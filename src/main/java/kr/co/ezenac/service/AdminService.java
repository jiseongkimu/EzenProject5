...
import kr.co.ezenac.dao.AdminDao;
...
public class AdminService {
	...
	public void getLoginAdminInfo(AdminBean tempLoginAdminBean) {
		...
		if (tempLoginAdminBean2 != null) {
			loginAdminBean.setAdmin_idx(tempLoginAdminBean2.getAdmin_idx());
			loginAdminBean.setAdmin_name(tempLoginAdminBean2.getAdmin_name());
