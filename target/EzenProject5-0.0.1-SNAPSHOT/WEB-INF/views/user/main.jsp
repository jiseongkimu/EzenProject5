	...
	<div class="carouselDiv" style="width: 100%; height: 700px;">
		<div style="width: 120px; height: 600px; margin-top: 0px;">
			<div class="card_banner_1" style="height: 200px; text-align: center;">
				<a href="${root}product/info"> <img
					src="${root}image/card_banner_1.jpg">
				</a>
			</div>
			<div class="card_banner_1" style="height: 150px;">
				<a href="${root}product/info"> <img
					src="${root}image/card_banner_2.jpg">
				</a>
			</div>
			<div class="card_banner_1" style="height: 150px;">
				<a href="${root}product/info"> <img
					src="${root}image/card_banner_3.jpg">
				</a>
			</div>
		</div>
						...
						<div class="carousel-caption d-none d-md-block opacity-75"
							...
							<div class="MICEGothic">
								...
								<p>
									...
									최적의 환경에서 플레이 하고 싶은 당신을 위한 제품들을 모았읍니다.
								</p>
							</div>
						</div>
					</a>
		...
		<div class="product_banner_out">
			...
			<div class="product_banner">
				<a href="${root }product/info"><img class="banner"
					src="${root}image/event_product_1.jpg"></a>
			</div>

			<!-- 2 -->
			<div class="product_banner">
				<a href="${root }product/info"><img class="banner"
					src="${root}image/event_product_2.jpg"></a>
			</div>
		</div>
		...
		<div class="cover hor_banner row row-cols-1 row-cols-md-3 g-4"
				...
				<div class="row g-0">
					<div>
						<a href="${root }product/info"><img id="card_image"
							src="${root}image/3x2_sample_1.jpg"
			...
			<div class="card mb-5 border-0">
				<div class="row g-0">
					<div>
						<a href="${root }product/info"><img id="card_image"
							src="${root}image/3x2_sample_2.jpg"
							class="img-fluid rounded-start" alt="..."> </a>
					</div>
					<div>
						<div class="card-body">
			...
			<div class="card mb-5 border-0">
				<div class="row g-0">
					<div>
						<a href="${root }product/info"><img id="card_image"
							src="${root}image/3x2_sample_3.jpg"
							class="img-fluid rounded-start" alt="..."> </a>
					</div>
					<div>
						<div class="card-body">
			...
			<div class="card mb-5 border-0">
				<div class="row g-0">
					<div>
						<a href="${root }product/info"><img id="card_image"
							src="${root}image/3x2_sample_4.png"
							class="img-fluid rounded-start" alt="..."> </a>
					</div>
					<div>
						<div class="card-body">
			...
			<div class="card mb-5 border-0">
				<div class="row g-0">
					<div>
						<a href="${root }product/info"><img id="card_image"
							src="${root}image/3x2_sample_5.jpg"
							class="img-fluid rounded-start" alt="..."> </a>
					</div>
					<div>
						<div class="card-body">
			...
			<div class="card mb-5 border-0">
				<div class="row g-0">
					<div>
						<a href="${root }product/info"><img id="card_image"
							src="${root}image/3x2_sample_6.jpg"
							class="img-fluid rounded-start" alt="..."> </a>
					</div>
					<div>
						<div class="card-body">
		...
		<div class="container" style="text-align: left;">
			...
			<div class="container text-center"
				...
				<div class="row" style="height: 400px;">
					...
					<div class="col">
						<a href="${root }product/info"> <img
							src="${root }image/wolf_1.png" id="card_image_w"
					...
					<div class="col">
						<a href="${root }product/info"> <img
							src="${root }image/wolf_2.png" id="card_image_w"
							class="card-img-top" alt="...">
			...
			<div class="container text-center"
				...
				<div class="row" style="height: 400px;">
					<div class="col">
						<img src="${root }image/goods_1.png" id="card_image_w"
							class="card-img-top" alt="...">
						<h5 class="card-title">예니퍼 피규어</h5>
					</div>
					<div class="col">
						<img src="${root }image/goods_2.png" id="card_image_w"
							class="card-img-top" alt="...">
				...
				<div class="row" style="height: 400px;">
					<div class="col">
						<img src="${root }image/wolf_5.png" id="card_image_w"
							class="card-img-top" alt="...">
						<h5 class="card-title" style="color: #ffffff">늑대 메달 1</h5>
					</div>
					<div class="col">
						<img src="${root }image/wolf_6.png" id="card_image_w"
							class="card-img-top" alt="...">
		...
		<div
				...
				Sass 에 $card-height: 100%를 설정하면, 클래스 추가 없이 기본적(항상)으로 같은 높이를 사용할 수 있다. -->
					<a href="${root }product/info">
						<div class="card h-100 border-0">
							<img src="image/best_product_1.jpg" class="card-img-top"
								alt="...">
							<div class="card-body">
								<h5 class="card-title">
			...
			<div class="col">
				...
				Sass 에 $card-height: 100%를 설정하면, 클래스 추가 없이 기본적(항상)으로 같은 높이를 사용할 수 있다. -->
					<a href="${root }product/info">
						<div class="card h-100 border-0">
							<img src="image/best_product_2.jpg" class="card-img-top"
								alt="...">
							<div class="card-body">
								<h5 class="card-title">
			...
			<div class="col">
				...
				Sass 에 $card-height: 100%를 설정하면, 클래스 추가 없이 기본적(항상)으로 같은 높이를 사용할 수 있다. -->
					<a href="${root }product/info">
						<div class="card h-100 border-0">
							<img src="image/best_product_3.jpg" class="card-img-top"
								alt="...">
							<div class="card-body">
								<h5 class="card-title">
			...
			<div class="col">
				...
				Sass 에 $card-height: 100%를 설정하면, 클래스 추가 없이 기본적(항상)으로 같은 높이를 사용할 수 있다. -->
					<a href="${root }product/info">
						<div class="card h-100 border-0">
							<img src="image/best_product_4.jpg" class="card-img-top"
								alt="...">
							<div class="card-body">
								<h5 class="card-title">
		...
		<div
			...
			<div class="col">
				...
				Sass 에 $card-height: 100%를 설정하면, 클래스 추가 없이 기본적(항상)으로 같은 높이를 사용할 수 있다. -->
					<a href="${root }product/info">
						<div class="card h-100 border-0">
							<img src="image/best_product_5.jpg" class="card-img-top"
								alt="...">
							<div class="card-body">
								<h5 class="card-title">
			...
			<div class="col">
				...
				Sass 에 $card-height: 100%를 설정하면, 클래스 추가 없이 기본적(항상)으로 같은 높이를 사용할 수 있다. -->
					<a href="${root }product/info">
						<div class="card h-100 border-0">
							<img src="image/best_product_6.jpg" class="card-img-top"
								alt="...">
							<div class="card-body">
								<h5 class="card-title">
			...
			<div class="col">
				...
				Sass 에 $card-height: 100%를 설정하면, 클래스 추가 없이 기본적(항상)으로 같은 높이를 사용할 수 있다. -->
					<a href="${root }product/info">
						<div class="card h-100 border-0">
							<img src="image/best_product_7.jpg" class="card-img-top"
								alt="...">
							<div class="card-body">
								<h5 class="card-title">
			...
			<div class="col">
				...
				Sass 에 $card-height: 100%를 설정하면, 클래스 추가 없이 기본적(항상)으로 같은 높이를 사용할 수 있다. -->
					<a href="${root }product/info">
						<div class="card h-100 border-0">
							<img src="image/best_product_8.jpg" class="card-img-top"
								alt="...">
							<div class="card-body">
								<h5 class="card-title">
